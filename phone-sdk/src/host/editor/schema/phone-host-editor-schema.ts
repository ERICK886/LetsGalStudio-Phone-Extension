...
export const PHONE_HOST_CONTENT_ITEMS: readonly PhoneEditorContentItemSchema[] = [
  ...
  {
    id: "phoneHudButtonType",
    group: "HUD 内容",
    label: "按钮类型",
    icon: "shapes",
    fieldType: "enum",
    defaultValue: "icon",
    enumOptions: PHONE_HUD_BUTTON_TYPES.map((value) => ({
      value,
      label: value === "icon" ? "图标按钮" : value === "text" ? "文本按钮" : "图片按钮",
    })),
  ...
  },
  {
    ...
    defaultValue: "打开手机",
    description: "仅用于文本按钮。",
    dependsOn: { contentItemId: "phoneHudButtonType", equals: "text" },
  },
  {
    id: "phoneHudIconPreset",
    group: "HUD 内容",
    label: "图标预设",
    icon: "icons",
    fieldType: "enum",
    defaultValue: "phone",
    enumOptions: PHONE_HUD_ICON_PRESETS.map((value) => ({
      value,
      label: {
        phone: "📱 手机",
        grid: "▦ 应用网格",
    ...
    description: "未选择自定义图标时使用。",
    dependsOn: { contentItemId: "phoneHudButtonType", equals: "icon" },
  },
  {
    id: "phoneHudIcon",
    group: "HUD 内容",
    ...
    defaultValue: "",
    allowEmpty: true,
    description: "可选；会覆盖图标预设，并按“图标/文字大小”缩放。",
    dependsOn: { contentItemId: "phoneHudButtonType", equals: "icon" },
  },
  {
    id: "phoneHudImage",
    ...
    defaultValue: "",
    allowEmpty: true,
    description: "图片会铺满整个按钮。",
    dependsOn: { contentItemId: "phoneHudButtonType", equals: "image" },
  },
  {
    id: "phoneHudStylePreset",
    group: "HUD 外观",
    label: "外观预设",
    icon: "palette",
    fieldType: "enum",
    defaultValue: "dark-glass",
    enumOptions: PHONE_HUD_STYLE_PRESETS.map((value) => ({
      value,
      label: {
        "dark-glass": "深色玻璃",
        light: "浅色",
  ...
  },
  {
    ...
    defaultValue: "",
    allowEmpty: true,
    description: "作为按钮背景铺满显示，可叠加文本或图标。",
    dependsOn: { contentItemId: "showPhoneHudButton", equals: "true" },
  },
  {
    id: "phoneHudBackgroundColor",
    group: "HUD 外观",
    label: "自定义背景色",
    icon: "fill-drip",
    fieldType: "color",
    defaultValue: "#12161F",
    dependsOn: { contentItemId: "phoneHudStylePreset", equals: "custom" },
  },
  {
    id: "phoneHudTextColor",
    group: "HUD 外观",
    label: "自定义内容颜色",
    icon: "font",
    fieldType: "color",
  ...
  },
  {
    ...
    max: 400,
    step: 1,
    description: "0 为自动：图标/图片按钮保持方形，文本按钮按内容自适应。",
    dependsOn: { contentItemId: "showPhoneHudButton", equals: "true" },
  },
  {
    id: "phoneHudContentSize",
    group: "HUD 尺寸与位置",
    label: "图标/文字大小（像素）",
    icon: "up-right-and-down-left-from-center",
    fieldType: "number",
