...
export const PHONE_CALL_EDITOR_PAGES: readonly PhoneEditorPageSchema[] = [
  ...
  { id: "call-incoming", label: "来电界面", icon: "phone-volume", order: 20, status: "ready", contentItemIds: ids("incomingLabel", "incomingHint", "incomingRequiredHint", "answerLabel", "declineLabel", "styleIncomingBg", "styleAnswer", "styleDecline"), preview: "phone-call" },
