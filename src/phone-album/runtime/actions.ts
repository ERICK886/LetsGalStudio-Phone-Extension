...
import type { AlbumMedia, MediaType } from "../types";
import {
  applyAddAlbum,
  applyAddMedia,
  applyRemoveAlbum,
...
import {
  addCameraPhotoToShared,
  getAlbumSaveState,
  removeCameraPhotoFromShared,
  setAlbumSaveState,
} from "./store";
import { clearLastShotIf } from "./camera-session";
